...
const Room = ({room}) => {
  ...
  let backgroundColor = "bg-white"; // default color

  if (name.includes("Pink Home")) {
    backgroundColor = "bg-pink-200"; // Pembe
  }
  else if (name.includes("Artist Antik")) {
    backgroundColor = "bg-[#d1935a]"; 
  }


  
  return <div className={`${backgroundColor} shadow-2xl min-h-[500px] group`}>
